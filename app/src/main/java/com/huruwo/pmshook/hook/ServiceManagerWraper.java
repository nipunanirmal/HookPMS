...
public class ServiceManagerWraper {
    ...
    public static void PMSHook(Context context, String signed, String appPkgName, int hashCode) {
        try {
            ...
            LogXUtils.e("hook pms error:" + Log.getStackTraceString(e));
        }
    }
    ...
    public static void hookPMS(Context context) {
        ...
        PMSHook(context, qqSign, "com.huruwo.pmshook", 0);
    }
}
